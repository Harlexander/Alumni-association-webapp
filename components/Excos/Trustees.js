  ...
  return (
    <div className='md:px-40 px-5 py-24 space-y-20 bg-yellow-400'> 
        ...
        <div className='flex flex-col md:flex-row justify-between text-center'>
            <div>
                <img src='https://www.boxmodels.ng/wp-content/uploads/2020/03/benjamin-mokelu-box-models-agency-main.jpg' style={{ objectFit : "contain"}} className='object-fit md:h-72 h-52 w-52 mx-auto md:w-72 rounded-full'/>
