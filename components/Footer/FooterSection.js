            ...
            <div className='col-span-6 flex  md:flex-row flex-col gap-4 md:gap-0 justify-between mt-10 md:mt-24 py-4'>
                <div className='col-1'>
                    ...
                    <ul className='text-gray-900 font-montserrat text-sm space-y-2'>
                        ...
                        <li><a href='#' className='hover:text-yellow-900 hover:font-bold'>pro@sjssaa.com</a></li>
                        <li><a href='#' className='hover:text-yellow-900 hover:font-bold'>dom@sjsss.com</a></li>
                        <li><a href='#' className='hover:text-yellow-900 hover:font-bold'>secretary@sjsss.com</a></li>
                ...
                <div className='col-1'>
                    ...
                    <ul className='text-gray-800 font-montserrat text-sm space-y-2'>
                        ...
                        <li><Link href='/executives'><a className='hover:text-yellow-900 hover:font-bold'>Executives</a></Link></li>
